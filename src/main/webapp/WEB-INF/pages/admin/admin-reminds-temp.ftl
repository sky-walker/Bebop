...
<#if entity.optType=0>
	<div class="pm-item">
    	<table>
            ...
            <td rowspan="2" valign="top" width="50px">
            	<div  class="pm-item-head">
                	<a href="/blog/${entity.who.name}" target="blank">
                		<img src="${entity.who.portraint}" class="img-rounded"  style="width:35px;height:35px;" border="0">
                	</a>
                </div>
            </td>
          ...
          <tr>
            <td>
		    	<i class="icon-time"></i>&nbsp;<span class="timeago muted" title="${entity.optTime?string('yyyy-MM-dd HH:mm:ss')}">${entity.optTime}</span>
