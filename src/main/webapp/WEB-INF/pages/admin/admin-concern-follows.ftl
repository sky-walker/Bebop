          ...
          <div class="span9 board back-right">
                ...
                <div class="back-right-inner">
                    ...
                    <ul class="nav nav-tabs">
                      <li class="active">
                        <a href="/admin/concern/follows">我的关注<span class="badge badge-info">${pager.totalRecords}</span></a>
                      </li>
                    ...
                    <div class="tabbable tabs-right">
                      <ul class="nav nav-tabs">
                        <li <#if sortby = 'update'>class="active"</#if> ><a href="/admin/concern/follows?sortby=update">最近更新</a></li>
                        <li <#if sortby = 'time'>class="active"</#if> ><a href="/admin/concern/follows?sortby=time">关注时间</a></li>
                        <li <#if sortby = 'login'>class="active"</#if> ><a href="/admin/concern/follows?sortby=login">登录时间</a></li>
                      </ul>
                      <!-- concern-item start ================================================== -->
					  ...
					  <@p.page pager=pager link="/admin/concern/follows?" showPageNum=9 anchor=""/>
                    </div>
                    <!-- concern end ================================================== -->
                </div>
          </div>
