...
<body>
	...
	<div id="admin_main">
		...
		<div id="adminMain">
			<div id="admin_path">
				<h3 class="admin_path_h3">
					<a href="#">返回我的首页</a> » <a href="/admin">管理</a> » <a href="/admin/concern">关注管理</a> » <a href="/admin/feed/follows">我关注的动态</a>
				</h3>
			</div>
			<!-- msgs开始 -->
			<div id="messages">
				<dl class="kandyTabs">
				<dt class="tabtitle">
					<a href="/admin/feed/follows"><span class="tabbtn tabcur">我关注的动态(共<em>${pager.totalRecords}</em>条动态)</span></a>
					<a href="/admin/feed/my"><span class="tabbtn">我的动态</span></a>
		    ...
		    <@p.page pager=pager link="/admin/feed/follows?" showPageNum=9 anchor=""/>
		    <#-- 分页标签 END -->
			<!-- adminMain结束 -->
			<script type="text/javascript">
				$(function() {
		...
		<input type="hidden" id="receiveMsgType" value="0"/>
