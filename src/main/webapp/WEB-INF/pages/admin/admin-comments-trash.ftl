          ...
          <div class="span9 board back-right">
                ...
                <div class="back-right-inner">
                    ...
                    <ul class="nav nav-tabs">
                      ...
                      <li  class="active">
                        <a href="/admin/comments/trash">垃圾评论&nbsp;<span class="badge badge-info">${pager.totalRecords}</span></a>
                      </li>
                    </ul>
                    <!-- pm-item start ================================================== -->
				            ...
				            <td align="right">
				            	<#if entity.visible==1>
					          		<span id="invisible_${entity.id}">
						          		...
						          		<a href="javascript:invisible_comment(${entity.id})">垃圾&nbsp;</a>|
					          		</span>
					          		<span id="visible_${entity.id}" style="display:none;">
						          		<a href="javascript:visible_comment(${entity.id})"  title="恢复评论">显示&nbsp;</a>|
				    ...
				    <@p.page pager=pager link="/admin/comments/trash?" showPageNum=9 anchor=""/>
				    <#-- 分页标签 END -->
                </div>
          </div>
          <!-- back-right end ================================================== -->
