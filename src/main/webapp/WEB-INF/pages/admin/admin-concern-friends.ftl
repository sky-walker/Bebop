          ...
          <div class="span9 board back-right">
                ...
                <div class="back-right-inner">
                    ...
                    <ul class="nav nav-tabs">
                      ...
                      <li><a href="/admin/concern/fans">我的粉丝</a></li>
                      <li  class="active"><a href="/admin/concern/friends">互为关注<span class="badge badge-info">${pager.totalRecords}</span></a></li>
                      <li><a href="javascript:add_concern()">+添加关注</a></li>
                    </ul>
                    <div class="tabbable tabs-right">
                      <ul class="nav nav-tabs">
                        <li <#if sortby = 'update'>class="active"</#if> ><a href="/admin/concern/friends?sortby=update">最近更新</a></li>
                        <li <#if sortby = 'time'>class="active"</#if> ><a href="/admin/concern/friends?sortby=time">关注时间</a></li>
                        <li <#if sortby = 'login'>class="active"</#if> ><a href="/admin/concern/friends?sortby=login">登录时间</a></li>
                      </ul>
                      <!-- concern-item start ================================================== -->
					  ...
					  <@p.page pager=pager link="/admin/concern/friends?" showPageNum=9 anchor=""/>
                    </div>
                    <!-- concern end ================================================== -->
                </div>
          </div>
