          ...
          <div class="span9 board style="float:right">
                <div class="front-right-inner">
                    ...
                    <div class="divbord">
                    	...
                    	<#else>
                    		<h6 style="margin-left:15px;">@${user.nickname}&nbsp;&nbsp; 的关注</h6>
                    		<#list pager.resultList as entity>
							   <#include "/share/blog-concern-template.ftl" />
						    </#list>
                    	</#if>
                    	<#-- 分页标签 BEGIN -->
					    <#import "/share/pager_.ftl" as p>
					    <@p.page pager=pager link="/blog/${user.name}/follows?" showPageNum=9 anchor=""/>
					    <#-- 分页标签 END -->
				    </div>
                    <!-- post-item end ================================================== -->
                </div>
